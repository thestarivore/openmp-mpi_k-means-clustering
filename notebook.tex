...
easily test the K-Means Clustering algorithm.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X,Y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
see if it can also individuate the clusters.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{x} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{N\PYZus{}SAMPLES}\PY{p}{)}
...
Let's print the centroids:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Cluster,X,Y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
Total centroids: 4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{x} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{centroids}\PY{p}{)}
...
resulting clusters separated by a random color and their centroids:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{random\PYZus{}color}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{k}{return} \PY{n}{numpy}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{rand}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{x} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{N\PYZus{}SAMPLES}\PY{p}{)}
         \PY{n}{y} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n}{N\PYZus{}SAMPLES}\PY{p}{)}
...
MPI + OpenMP Execution    --> 2597.859ms
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{objfun} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}
...
between 1 and 10.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k}{def} \PY{n+nf}{getResultsData}\PY{p}{(}\PY{n}{fname}\PY{p}{)}\PY{p}{:}
...
\subsubsection{2.1) Dataset size: 100}\label{dataset-size-100}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{def} \PY{n+nf}{plotRealtionCentroidsExecTime}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
\subsubsection{2.3) Dataset size: 10K}\label{dataset-size-10k}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{EXECUTIONS}\PY{p}{,} \PY{n}{n\PYZus{}t}\PY{p}{,} \PY{n}{openmp\PYZus{}t}\PY{p}{,} \PY{n}{mpi\PYZus{}t}\PY{p}{,} \PY{n}{mpi\PYZus{}mp\PYZus{}t}\PY{p}{,} \PY{n}{n\PYZus{}c}\PY{p}{,} \PY{n}{openmp\PYZus{}c}\PY{p}{,} \PY{n}{mpi\PYZus{}c}\PY{p}{,} \PY{n}{mpi\PYZus{}mp\PYZus{}c}\PY{p}{,} \PY{n}{n\PYZus{}of} \PY{o}{=} \PY{n}{getResultsData}\PY{p}{(}\PY{n}{results\PYZus{}10K\PYZus{}path}\PY{p}{)}
         \PY{n}{plotRealtionCentroidsExecTime}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\subsubsection{2.4) Dataset size: 100K}\label{dataset-size-100k}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{EXECUTIONS}\PY{p}{,} \PY{n}{n\PYZus{}t}\PY{p}{,} \PY{n}{openmp\PYZus{}t}\PY{p}{,} \PY{n}{mpi\PYZus{}t}\PY{p}{,} \PY{n}{mpi\PYZus{}mp\PYZus{}t}\PY{p}{,} \PY{n}{n\PYZus{}c}\PY{p}{,} \PY{n}{openmp\PYZus{}c}\PY{p}{,} \PY{n}{mpi\PYZus{}c}\PY{p}{,} \PY{n}{mpi\PYZus{}mp\PYZus{}c}\PY{p}{,} \PY{n}{n\PYZus{}of} \PY{o}{=} \PY{n}{getResultsData}\PY{p}{(}\PY{n}{results\PYZus{}100K\PYZus{}path}\PY{p}{)}
         \PY{n}{plotRealtionCentroidsExecTime}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\subsubsection{2.5) Dataset size: 1M}\label{dataset-size-1m}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{EXECUTIONS}\PY{p}{,} \PY{n}{n\PYZus{}t}\PY{p}{,} \PY{n}{openmp\PYZus{}t}\PY{p}{,} \PY{n}{mpi\PYZus{}t}\PY{p}{,} \PY{n}{mpi\PYZus{}mp\PYZus{}t}\PY{p}{,} \PY{n}{n\PYZus{}c}\PY{p}{,} \PY{n}{openmp\PYZus{}c}\PY{p}{,} \PY{n}{mpi\PYZus{}c}\PY{p}{,} \PY{n}{mpi\PYZus{}mp\PYZus{}c}\PY{p}{,} \PY{n}{n\PYZus{}of} \PY{o}{=} \PY{n}{getResultsData}\PY{p}{(}\PY{n}{results\PYZus{}1M\PYZus{}path}\PY{p}{)}
...
Project;
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{num\PYZus{}centroids} \PY{o}{=} \PY{l+m+mi}{10}
...
ExecutionTime}\label{relation-between-datasets-number-of-points-and-executiontime}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{num\PYZus{}of\PYZus{}points} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{1000}\PY{p}{,}\PY{l+m+mi}{10000}\PY{p}{,}\PY{l+m+mi}{100000}\PY{p}{,}\PY{l+m+mi}{1000000}\PY{p}{]}
         \PY{n}{obj\PYZus{}mean\PYZus{}vals\PYZus{}4p} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} \PYZhy{}p 4}
         \PY{n}{obj\PYZus{}mean\PYZus{}vals\PYZus{}1p} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} \PYZhy{}p 1}
